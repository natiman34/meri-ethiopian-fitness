...
export class DirectEmailService {
    static instance;
    apiKey = 're_7rddcDCt_7LdvJvjmMjZXKRvWR8ybqsZs';
     ...
     */
    async sendFeedbackReply(userEmail, userName, feedbackContent, adminReply) {
     ...
     */
    createEmailHTML(userName, feedbackContent, adminReply) {
        return `
     ...
     */
    createEmailText(userName, feedbackContent, adminReply) {
...
Your Fitness Journey Partner`;
    ...
    async testDirectEmail() {
        ...
        return this.sendFeedbackReply('nati737313@gmail.com', 'Direct Test User', 'This is a test of the direct email service.', 'This is a test reply from the direct email service. If you receive this, the backup system is working!');
    }
}
