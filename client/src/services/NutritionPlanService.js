...
import { getAllNutritionPlans as getLocalAllNutritionPlans, getNutritionPlanById as getLocalNutritionPlanById, getNutritionPlansByCategory as getLocalNutritionPlansByCategory, getNutritionPlansByCalorieRange as getLocalNutritionPlansByCalorieRange } from "../data/nutritionPlans";
...
export class NutritionPlanService {
    ...
    convertDbPlanToFrontend(dbPlan) {
        return new NutritionPlan({
            ...
            meals: dbPlan.meal_plan?.meals?.map((meal, index) => ({
                day: index + 1,
                name: `Day ${index + 1}`,
    ...
    async updateNutritionPlan(plan) {
    ...
    async getNutritionPlansByCategory(categoryId) {
        try {
    ...
    async getNutritionPlansByCalorieRange(min, max) {
