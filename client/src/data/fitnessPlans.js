...
export const getAllFitnessPlans = () => {
    return fitnessPlans;
};
export const getFeaturedFitnessPlans = () => {
    return fitnessPlans.filter(plan => plan.featured);
};
export const getFitnessPlansByLevel = (level) => {
    return fitnessPlans.filter(plan => plan.level === level);
};
export const getFitnessPlansByCategory = (category) => {
