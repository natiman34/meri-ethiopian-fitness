...
export interface MotivationalQuote {
  ...
  text: string
  author: string
  category: 'habits' | 'mindset' | 'motivation' | 'perseverance' | 'self-care' | 'goals' | 'progress'
  tags?: string[]
}
...
export const getRandomQuoteByCategory = (category: MotivationalQuote['category']): MotivationalQuote => {
...
export interface FitnessTip {
  ...
  title: string
  description: string
  category: 'motivation' | 'habits' | 'mindset' | 'practical'
  actionSteps: string[]
}

export const fitnessTips: FitnessTip[] = [
  {
    id: "follow-plan",
...
export const getFitnessTipsByCategory = (category: FitnessTip['category']): FitnessTip[] => {
