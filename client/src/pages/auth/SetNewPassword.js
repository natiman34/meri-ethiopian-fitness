...
const SetNewPassword = () => {
    ...
    const [resetTokens, setResetTokens] = useState({ accessToken: '', refreshToken: null });
    ...
    const checkTokenExpiry = (token) => {
        try {
            ...
            if (tokenParts.length !== 3)
                return { isExpired: true, expiresIn: 0, warning: "" };
            const payload = JSON.parse(atob(tokenParts[1]));
            const currentTime = Math.floor(Date.now() / 1000);
            const expiryTime = payload.exp;
            if (!expiryTime)
                return { isExpired: false, expiresIn: Infinity, warning: "" };
    ...
    if (isCheckingToken) {
        return (_jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "max-w-md w-full space-y-8", children: [_jsx("div", { className: "text-center", children: _jsx(Link, { to: "/", className: "inline-block", children: _jsxs("div", { className: "font-bold text-3xl flex items-center justify-center", children: [_jsx("span", { className: "text-red-600", children: "\u1218\u122A" }), _jsx("span", { className: "text-yellow-600", children: "Ethiopian" }), _jsx("span", { className: "text-green-600", children: "Fitness" }), _jsx("span", { className: "ml-2 text-gray-800" })] }) }) }), _jsx(Card, { children: _jsx(Card.Body, { children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-green-600 mx-auto mb-4" }), _jsx("p", { className: "text-gray-600", children: "Validating reset token..." })] }) }) })] }) }));
    }
    if (isSuccess) {
        return (_jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "max-w-md w-full space-y-8", children: [_jsx("div", { className: "text-center", children: _jsx(Link, { to: "/", className: "inline-block", children: _jsxs("div", { className: "font-bold text-3xl flex items-center justify-center", children: [_jsx("span", { className: "text-red-600", children: "\u1218\u122A" }), _jsx("span", { className: "text-yellow-600", children: "Ethiopian" }), _jsx("span", { className: "text-green-600", children: "Fitness" }), _jsx("span", { className: "ml-2 text-gray-800" })] }) }) }), _jsx(Card, { children: _jsx(Card.Body, { children: _jsxs("div", { className: "text-center", children: [_jsx(CheckCircle, { className: "mx-auto h-12 w-12 text-green-500 mb-4" }), _jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Password Reset Complete!" }), _jsx("p", { className: "text-gray-600 mb-4", children: "Your password has been updated successfully." }), _jsx("p", { className: "text-sm text-gray-500 mb-6", children: "For security reasons, you have been logged out. Please log in with your new password." }), _jsx("div", { className: "text-xs text-gray-400 mb-4", children: "Redirecting to login page in 3 seconds..." }), _jsx(Link, { to: "/login", className: "inline-flex items-center text-sm text-green-600 hover:text-green-500", children: "Go to login now" })] }) }) })] }) }));
    }
    if (!isValidToken) {
        return (_jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "max-w-md w-full space-y-8", children: [_jsx("div", { className: "text-center", children: _jsx(Link, { to: "/", className: "inline-block", children: _jsxs("div", { className: "font-bold text-3xl flex items-center justify-center", children: [_jsx("span", { className: "text-red-600", children: "\u1218\u122A" }), _jsx("span", { className: "text-yellow-600", children: "Ethiopian" }), _jsx("span", { className: "text-green-600", children: "Fitness" }), _jsx("span", { className: "ml-2 text-gray-800" })] }) }) }), _jsx(Card, { children: _jsx(Card.Body, { children: _jsxs("div", { className: "text-center", children: [_jsx(AlertCircle, { className: "mx-auto h-12 w-12 text-red-500 mb-4" }), _jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-4", children: "Password Reset Issue" }), _jsx("p", { className: "text-gray-600 mb-6", children: error }), _jsxs("div", { className: "space-y-3", children: [_jsx(Link, { to: "/reset-password", className: "inline-flex items-center justify-center w-full px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors", children: "Request New Password Reset" }), _jsx(Link, { to: "/login", className: "inline-flex items-center justify-center w-full px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors", children: "Back to Login" })] })] }) }) })] }) }));
    }
    return (_jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "max-w-md w-full space-y-8", children: [_jsxs("div", { className: "text-center", children: [_jsx(Link, { to: "/", className: "inline-block", children: _jsxs("div", { className: "font-bold text-3xl flex items-center justify-center", children: [_jsx("span", { className: "text-red-600", children: "\u1218\u122A" }), _jsx("span", { className: "text-yellow-600", children: "Ethiopian" }), _jsx("span", { className: "text-green-600", children: "Fitness" }), _jsx("span", { className: "ml-2 text-gray-800" })] }) }), _jsx("h2", { className: "mt-6 text-3xl font-extrabold text-gray-900", children: "Set new password" }), _jsx("p", { className: "mt-2 text-sm text-gray-600", children: "Enter your new password below." })] }), _jsx(Card, { children: _jsxs(Card.Body, { children: [error && (_jsx("div", { className: "mb-4 p-3 bg-red-50 text-red-700 rounded-md text-sm", children: error })), tokenExpiryWarning && (_jsx("div", { className: "mb-4 p-3 bg-yellow-50 text-yellow-700 rounded-md text-sm", children: _jsxs("div", { className: "flex items-center", children: [_jsx(AlertCircle, { className: "h-4 w-4 mr-2" }), tokenExpiryWarning] }) })), _jsxs("form", { className: "space-y-6", onSubmit: handleSubmit, children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "password", className: "block text-sm font-medium text-gray-700", children: "New Password" }), _jsxs("div", { className: "mt-1 relative", children: [_jsx("input", { id: "password", name: "password", type: showPassword ? "text" : "password", autoComplete: "new-password", required: true, value: password, onChange: (e) => setPassword(e.target.value), className: "block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500", placeholder: "Enter new password" }), _jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: _jsx(Lock, { className: "h-5 w-5 text-gray-400" }) }), _jsx("button", { type: "button", className: "absolute inset-y-0 right-0 pr-3 flex items-center", onClick: toggleShowPassword, children: showPassword ? (_jsx(EyeOff, { className: "h-5 w-5 text-gray-400" })) : (_jsx(Eye, { className: "h-5 w-5 text-gray-400" })) })] }), _jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Password must be at least 6 characters long" })] }), _jsxs("div", { children: [_jsx("label", { htmlFor: "confirmPassword", className: "block text-sm font-medium text-gray-700", children: "Confirm New Password" }), _jsxs("div", { className: "mt-1 relative", children: [_jsx("input", { id: "confirmPassword", name: "confirmPassword", type: showConfirmPassword ? "text" : "password", autoComplete: "new-password", required: true, value: confirmPassword, onChange: (e) => setConfirmPassword(e.target.value), className: "block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500", placeholder: "Confirm new password" }), _jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: _jsx(Lock, { className: "h-5 w-5 text-gray-400" }) }), _jsx("button", { type: "button", className: "absolute inset-y-0 right-0 pr-3 flex items-center", onClick: toggleShowConfirmPassword, children: showConfirmPassword ? (_jsx(EyeOff, { className: "h-5 w-5 text-gray-400" })) : (_jsx(Eye, { className: "h-5 w-5 text-gray-400" })) })] })] }), _jsx("div", { children: _jsx(Button, { type: "submit", variant: "primary", fullWidth: true, isLoading: isLoading, children: "Update Password" }) })] })] }) })] }) }));
};
