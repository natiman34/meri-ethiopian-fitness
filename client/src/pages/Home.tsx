          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 bg-green-700 text-white">
                ...
                <p className="mb-6">
                  Our team is here to help you on your fitness and nutrition journey. Send us a message and we'll get back to you as soon as possible.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span>info@ethiopianfitness.com</span>
                  </div>
                  <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="p-8">
                <div className="text-center">
                  <p className="text-gray-600 mb-6">
                    Visit our contact page for more information or to send us a detailed message.
                  </p>
                  <Link to="/contact">
                    <Button variant="primary" className="bg-green-600 hover:bg-green-700 w-full">
                      Contact Us
                    </Button>
                  </Link>
                </div>
