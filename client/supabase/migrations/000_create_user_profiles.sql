-- Create user_profiles table with proper constraints to prevent duplicate registrations
-- This migration should run before other migrations that depend on user_profiles
